...
uClient = uReq(nordstrom_gifts_her_url)
...
for container in containers:
    ...
    title_container = container.findAll("a", {"class":"item-title"}) #title of the product is a text of the a tag and the a tag details are returned as an array
